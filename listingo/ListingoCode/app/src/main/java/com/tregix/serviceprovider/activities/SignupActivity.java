...
import static com.tregix.serviceprovider.activities.BookAppointmentDetailActivity.REQUEST_CODE_VERIFICATION;
...
public class SignupActivity extends BaseActivity implements OnSignupLoginListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.terms_condition).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openWebview(Constants.TERMSOFUSE, getString(R.string.title_terms_of_use));
            }
        });
    ...
    private void signUp() {
        ...
        Intent intent = new Intent(SignupActivity.this, PhoneNumberVerificationActivity.class);
    ...
    @Override
    protected void onNumberVerified() {
    ...
    protected void updateUI(GoogleSignInAccount account) {
        if(account != null) {
            ...
            String nam = Constants.EMPTY_STRING;
            if(account.getGivenName() != null){
                nam = account.getGivenName();
            }else if(account.getDisplayName() != null){
                nam = account.getDisplayName();
            }
            String[] username = nam.split(" ");
            ...
            businessUser = new RegisterUser();
            businessUser.setPassword(account.getId());
            businessUser.setConfirmPassword(account.getId());
        }
    }
