...
public class Appointment implements Serializable{
    ...
    public String toString() {
        ...
        String data =  " <strong>Appointment Id : </strong> <span>"+ key +"</span> <br></br><br></br>" +
                "<strong>Provider : </strong> <span>"+provider+"</span> <br></br><br></br>" +
                " <strong>Date : </strong> <span>"+ AppUtils.longToDate(aptDate,"MMM dd, yyyy",1000)+"</span><br></br> <br></br>"+
                " <strong>Time : </strong> <span>"+ aptTime +"</span> <br></br><br></br>"+
                ...
                " <strong>Description : </strong> <span>"+aptDescription+"</span> <br></br><br></br>"+
                " <strong>Status : </strong> <span>"+status+"</span> <br></br>";
