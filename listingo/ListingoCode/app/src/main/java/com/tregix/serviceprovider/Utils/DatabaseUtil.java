...
public class DatabaseUtil {
    ...
    @NonNull
    public List<String> getSubCategorySlug(int cat, String subCat) {

        List<String> slug = new ArrayList<String>();
        if(subCat != null && !subCat.isEmpty()) {
            ...
            if (requiredCat.getSubCategories() != null && !requiredCat.getSubCategories().isEmpty()) {
                for (SubCategory category : requiredCat.getSubCategories()) {
                    if (Html.fromHtml(category.getTitle()).toString().equals(Html.fromHtml(subCat).toString())) {
                        slug.add(category.getSlug());
                        return slug;
                    }
                }
            }
...
//        }
//        return categories;
        String[] lang = {"English", "Vietnamese", "Any"};
        return new ArrayList<>(Arrays.asList(lang));
    }

    @NonNull
    public ArrayList<String> getGenders() {
        String[] gender = {"Male", "Female"};
        return new ArrayList<>(Arrays.asList(gender));
    }
}
