...
public class ManageAppointmentsAdapter extends RecyclerView.Adapter<ManageAppointmentViewHolder> {
    ...
    public void onBindViewHolder(final ManageAppointmentViewHolder holder, final int position) {
        ...
        holder.service.setText(  holder.service.getContext().getString(R.string.apt_service)+" " + mValues.get(position).getAptServices());
        holder.type.setText(holder.service.getContext().getString(R.string.apt_type) +" " + mValues.get(position).getAptTypes());
        holder.status.setText(holder.service.getContext().getString(R.string.status) +" " + mValues.get(position).getStatus());
